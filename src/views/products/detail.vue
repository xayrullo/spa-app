    ...
    <main class="w-full flex flex-col lg:flex-row">
      <section
        class="
          ...
          flex-col
          gap-8
          sm:flex sm:flex-row sm:gap-4 sm:h-full sm:mt-24 sm:mx-2
          md:gap-8 md:mx-4
          lg:flex-col lg:mx-0
        "
      >
        ...
        <div
          class="
            ...
            gap-4
            m-auto
            sm:flex sm:flex-col sm:justify-start sm:items-center sm:h-fit
            md:gap-5
            lg:flex-row
          "
        >
        ...
        >
          ...
          <p
            class="
              ...
              w-fit
              line-through
              decoration-dark-grayish decoration-1
              my-auto
            "
          >
            ${{ product.price }}
